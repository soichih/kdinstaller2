...
app.controller('kdinstallerController', function($scope, sca, $timeout) {
    ...
    */
    ...
    case "win32":
        ...
        $scope.install_cmd = "powershell.exe -nologo -noprofile -command \"& { Add-Type -A 'System.IO.Compression.FileSystem'; Remove-Item '"+install_dir+"' -Force -Recurse -ErrorAction Ignore; [IO.Compression.ZipFile]::ExtractToDirectory('" + $scope.download_path + "', '" + install_dir + "'); }\"";
